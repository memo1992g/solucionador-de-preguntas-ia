...
import { normalizeLanguageText } from "@/lib/language";
...
function buildInterviewExample(question: string, answer: string) {
  ...
  const topicExamples = TOPIC_EXAMPLES_ES;
  ...
  const fallbackTopic = "este concepto";

  if (style === "comparison") {
    return topic === fallbackTopic
      ? "Es como comparar dos opciones para ver cuál te sirve más."
