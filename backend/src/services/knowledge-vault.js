const KNOWLEDGE_VAULT_SECTIONS = [
  {
    ...
    bullets: [
      ...
      "El objetivo del producto es ayudar a resolver dudas con criterio senior, tono claro y respuestas breves cuando sea posible.",
  ...
  },
  {
    title: "Capacidades",
    bullets: [
      "El asistente sabe conversar sobre desarrollo full stack, Spring Boot, Java, SQL, microservicios, colas, testing, seguridad y performance.",
      "También cubre Next.js, React, Tailwind, Node.js, Express, OpenAI Realtime, WebRTC, despliegue, troubleshooting y code review.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Mantener respuestas naturales, humanas y concisas salvo que el usuario pida profundidad.",
    ],
  },
  {
